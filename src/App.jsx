      ...
      <div className="works-steps-container">
        <div className="work-step">
          ...
          <p className="step-description">
            Siz yuqoridagi maydonda istalgan inglizcha so'zni kiriting va
        ...
        <div className="work-step">
          ...
          <p className="step-description">
            Ilova so'zingizni lug'at API (dictionaryapi.dev) ga yuboradi va
            to'liq ma'lumotni oladi.
          </p>
        </div>
        ...
        <div className="work-step">
          ...
          <p className="step-description">
            Siz darhol ta'rif, talaffuz, sinonimlar va misollarni chiroyli
            formatda ko'rasiz.
          </p>
        </div>
        ...
        <div className="work-step">
          <h3 className="step-heading">
            Powered by{" "}
            <a target="_blank" href="https://foziljonovxumoyun.uz">
              {" "}
              <br />
              fzlx.uz
            </a>
  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        {!loading && !error && !wordData && !currentWord && (
          <>
            <div className="welcome-message">
              ...
              <p>
                Search for any word to see its definition, pronunciation, and
                examples.
              </p>
            </div>
            <HowItWorks />
        ...
        {/* Word display */}
        {wordData && (
          <WordDisplay data={wordData} onSynonymClick={handleSynonymClick} />
        )}
      </main>
